...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_rolePermissions_rolePermissions_component__ = __webpack_require__("./src/app/components/rolePermissions/rolePermissions.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_permissions_permissions_component__ = __webpack_require__("./src/app/components/permissions/permissions.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_orders_orders_component__ = __webpack_require__("./src/app/components/orders/orders.component.ts");
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                __WEBPACK_IMPORTED_MODULE_1__angular_router__["e" /* RouterModule */].forRoot([
                    { path: "", component: __WEBPACK_IMPORTED_MODULE_3__components_home_home_component__["a" /* HomeComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_13__services_auth_guard_service__["a" /* AuthGuard */]], data: { title: "Home" } },
                    { path: "login", component: __WEBPACK_IMPORTED_MODULE_2__components_login_login_component__["a" /* LoginComponent */], data: { title: "Login" } },
                    { path: "customers", component: __WEBPACK_IMPORTED_MODULE_4__components_customers_customers_component__["a" /* CustomersComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_13__services_auth_guard_service__["a" /* AuthGuard */]], data: { title: "Customers" } },
                    { path: "role-permissions", component: __WEBPACK_IMPORTED_MODULE_5__components_rolePermissions_rolePermissions_component__["a" /* RolePermissionsComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_13__services_auth_guard_service__["a" /* AuthGuard */]], data: { title: "RolePermissions" } },
                    { path: "products", component: __WEBPACK_IMPORTED_MODULE_6__components_products_products_component__["a" /* ProductsComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_13__services_auth_guard_service__["a" /* AuthGuard */]], data: { title: "Products" } },
                    { path: "permissions", component: __WEBPACK_IMPORTED_MODULE_7__components_permissions_permissions_component__["a" /* PermissionsComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_13__services_auth_guard_service__["a" /* AuthGuard */]], data: { title: "Permissions" } },
                    { path: "orders", component: __WEBPACK_IMPORTED_MODULE_8__components_orders_orders_component__["a" /* OrdersComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_13__services_auth_guard_service__["a" /* AuthGuard */]], data: { title: "Orders" } },
                    { path: "settings", component: __WEBPACK_IMPORTED_MODULE_9__components_settings_settings_component__["a" /* SettingsComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_13__services_auth_guard_service__["a" /* AuthGuard */]], data: { title: "Settings" } },
                    { path: "about", component: __WEBPACK_IMPORTED_MODULE_10__components_about_about_component__["a" /* AboutComponent */], data: { title: "About Us" } },
                    { path: "home", redirectTo: "/", pathMatch: "full" },
                    { path: "**", component: __WEBPACK_IMPORTED_MODULE_11__components_not_found_not_found_component__["a" /* NotFoundComponent */], data: { title: "Page Not Found" } },
                ])
            ],
            exports: [
            ...
            providers: [
                __WEBPACK_IMPORTED_MODULE_12__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_13__services_auth_guard_service__["a" /* AuthGuard */]
            ]
        })
    ], AppRoutingModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ng2_toasty__ = __webpack_require__("./node_modules/ng2-toasty/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_ngx_bootstrap_popover__ = __webpack_require__("./node_modules/ngx-bootstrap/popover/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_ngx_bootstrap_carousel__ = __webpack_require__("./node_modules/ngx-bootstrap/carousel/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_ng2_charts__ = __webpack_require__("./node_modules/ng2-charts/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__app_error_handler__ = __webpack_require__("./src/app/app-error.handler.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__services_app_title_service__ = __webpack_require__("./src/app/services/app-title.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__services_app_translation_service__ = __webpack_require__("./src/app/services/app-translation.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__services_configuration_service__ = __webpack_require__("./src/app/services/configuration.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__services_local_store_manager_service__ = __webpack_require__("./src/app/services/local-store-manager.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__services_endpoint_factory_service__ = __webpack_require__("./src/app/services/endpoint-factory.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__services_notification_service__ = __webpack_require__("./src/app/services/notification.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__services_notification_endpoint_service__ = __webpack_require__("./src/app/services/notification-endpoint.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__services_role_permission_endpoint_service__ = __webpack_require__("./src/app/services/role-permission-endpoint.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__services_account_service__ = __webpack_require__("./src/app/services/account.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__services_role_permission_service__ = __webpack_require__("./src/app/services/role-permission.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__services_account_endpoint_service__ = __webpack_require__("./src/app/services/account-endpoint.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__directives_equal_validator_directive__ = __webpack_require__("./src/app/directives/equal-validator.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__directives_last_element_directive__ = __webpack_require__("./src/app/directives/last-element.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__directives_autofocus_directive__ = __webpack_require__("./src/app/directives/autofocus.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__directives_bootstrap_tab_directive__ = __webpack_require__("./src/app/directives/bootstrap-tab.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__directives_bootstrap_toggle_directive__ = __webpack_require__("./src/app/directives/bootstrap-toggle.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__directives_bootstrap_select_directive__ = __webpack_require__("./src/app/directives/bootstrap-select.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__directives_bootstrap_datepicker_directive__ = __webpack_require__("./src/app/directives/bootstrap-datepicker.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__pipes_group_by_pipe__ = __webpack_require__("./src/app/pipes/group-by.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__components_app_component__ = __webpack_require__("./src/app/components/app.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__components_login_login_component__ = __webpack_require__("./src/app/components/login/login.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__components_home_home_component__ = __webpack_require__("./src/app/components/home/home.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__components_customers_customers_component__ = __webpack_require__("./src/app/components/customers/customers.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__components_rolePermissions_rolePermissions_component__ = __webpack_require__("./src/app/components/rolePermissions/rolePermissions.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__components_products_products_component__ = __webpack_require__("./src/app/components/products/products.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__components_permissions_permissions_component__ = __webpack_require__("./src/app/components/permissions/permissions.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__components_orders_orders_component__ = __webpack_require__("./src/app/components/orders/orders.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__components_settings_settings_component__ = __webpack_require__("./src/app/components/settings/settings.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__components_about_about_component__ = __webpack_require__("./src/app/components/about/about.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47__components_not_found_not_found_component__ = __webpack_require__("./src/app/components/not-found/not-found.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__components_controls_banner_demo_component__ = __webpack_require__("./src/app/components/controls/banner-demo.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49__components_controls_todo_demo_component__ = __webpack_require__("./src/app/components/controls/todo-demo.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_50__components_controls_statistics_demo_component__ = __webpack_require__("./src/app/components/controls/statistics-demo.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_51__components_controls_notifications_viewer_component__ = __webpack_require__("./src/app/components/controls/notifications-viewer.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_52__components_controls_search_box_component__ = __webpack_require__("./src/app/components/controls/search-box.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_53__components_controls_user_info_component__ = __webpack_require__("./src/app/components/controls/user-info.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_54__components_controls_user_preferences_component__ = __webpack_require__("./src/app/components/controls/user-preferences.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_55__components_controls_users_management_component__ = __webpack_require__("./src/app/components/controls/users-management.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_56__components_controls_roles_management_component__ = __webpack_require__("./src/app/components/controls/roles-management.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_57__components_controls_role_editor_component__ = __webpack_require__("./src/app/components/controls/role-editor.component.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_11_ngx_bootstrap_popover__["a" /* PopoverModule */].forRoot(),
                __WEBPACK_IMPORTED_MODULE_12_ngx_bootstrap_dropdown__["a" /* BsDropdownModule */].forRoot(),
                __WEBPACK_IMPORTED_MODULE_13_ngx_bootstrap_carousel__["a" /* CarouselModule */].forRoot(),
            ...
            declarations: [
                __WEBPACK_IMPORTED_MODULE_37__components_app_component__["a" /* AppComponent */],
                __WEBPACK_IMPORTED_MODULE_38__components_login_login_component__["a" /* LoginComponent */],
                __WEBPACK_IMPORTED_MODULE_39__components_home_home_component__["a" /* HomeComponent */],
                __WEBPACK_IMPORTED_MODULE_40__components_customers_customers_component__["a" /* CustomersComponent */],
                __WEBPACK_IMPORTED_MODULE_41__components_rolePermissions_rolePermissions_component__["a" /* RolePermissionsComponent */],
                __WEBPACK_IMPORTED_MODULE_42__components_products_products_component__["a" /* ProductsComponent */],
                __WEBPACK_IMPORTED_MODULE_43__components_permissions_permissions_component__["a" /* PermissionsComponent */],
                __WEBPACK_IMPORTED_MODULE_44__components_orders_orders_component__["a" /* OrdersComponent */],
                __WEBPACK_IMPORTED_MODULE_45__components_settings_settings_component__["a" /* SettingsComponent */],
                __WEBPACK_IMPORTED_MODULE_55__components_controls_users_management_component__["a" /* UsersManagementComponent */], __WEBPACK_IMPORTED_MODULE_53__components_controls_user_info_component__["a" /* UserInfoComponent */], __WEBPACK_IMPORTED_MODULE_54__components_controls_user_preferences_component__["a" /* UserPreferencesComponent */],
                __WEBPACK_IMPORTED_MODULE_56__components_controls_roles_management_component__["a" /* RolesManagementComponent */], __WEBPACK_IMPORTED_MODULE_57__components_controls_role_editor_component__["a" /* RoleEditorComponent */],
                __WEBPACK_IMPORTED_MODULE_46__components_about_about_component__["a" /* AboutComponent */],
                __WEBPACK_IMPORTED_MODULE_47__components_not_found_not_found_component__["a" /* NotFoundComponent */],
                __WEBPACK_IMPORTED_MODULE_51__components_controls_notifications_viewer_component__["a" /* NotificationsViewerComponent */],
                __WEBPACK_IMPORTED_MODULE_52__components_controls_search_box_component__["a" /* SearchBoxComponent */],
                __WEBPACK_IMPORTED_MODULE_50__components_controls_statistics_demo_component__["a" /* StatisticsDemoComponent */], __WEBPACK_IMPORTED_MODULE_49__components_controls_todo_demo_component__["a" /* TodoDemoComponent */], __WEBPACK_IMPORTED_MODULE_48__components_controls_banner_demo_component__["a" /* BannerDemoComponent */],
                __WEBPACK_IMPORTED_MODULE_29__directives_equal_validator_directive__["a" /* EqualValidator */],
                __WEBPACK_IMPORTED_MODULE_30__directives_last_element_directive__["a" /* LastElementDirective */],
                __WEBPACK_IMPORTED_MODULE_31__directives_autofocus_directive__["a" /* AutofocusDirective */],
                __WEBPACK_IMPORTED_MODULE_32__directives_bootstrap_tab_directive__["a" /* BootstrapTabDirective */],
                __WEBPACK_IMPORTED_MODULE_33__directives_bootstrap_toggle_directive__["a" /* BootstrapToggleDirective */],
                __WEBPACK_IMPORTED_MODULE_34__directives_bootstrap_select_directive__["a" /* BootstrapSelectDirective */],
                __WEBPACK_IMPORTED_MODULE_35__directives_bootstrap_datepicker_directive__["a" /* BootstrapDatepickerDirective */],
                __WEBPACK_IMPORTED_MODULE_36__pipes_group_by_pipe__["a" /* GroupByPipe */]
            ],
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_25__services_role_permission_endpoint_service__["a" /* RolePermissionEndpoint */],
                __WEBPACK_IMPORTED_MODULE_26__services_account_service__["a" /* AccountService */],
                __WEBPACK_IMPORTED_MODULE_5_ngx_cookie_service__["a" /* CookieService */],
                __WEBPACK_IMPORTED_MODULE_27__services_role_permission_service__["a" /* RolePermissionService */],
                __WEBPACK_IMPORTED_MODULE_28__services_account_endpoint_service__["a" /* AccountEndpoint */],
            ...
            bootstrap: [__WEBPACK_IMPORTED_MODULE_37__components_app_component__["a" /* AppComponent */]]
        })
    ], AppModule);
    return AppModule;
}());
...
/***/ "./src/app/assets/images/demo/banner1.png":
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ "./src/app/assets/images/demo/banner2.png":
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "banner2.c2ec6b8ac2a6443487f7.png";

/***/ }),

/***/ "./src/app/assets/images/demo/banner3.png":
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"

/***/ }),

/***/ "./src/app/assets/images/demo/banner4.png":
/***/ (function(module, exports) {

module.exports = "data:image/png;base64,"
...
module.exports = "data:image/png;base64,"
...
module.exports = ".contact-us h4 {\n    margin-top: 22px;\n    margin-bottom: 13px;\n}\n\n.our-values {\n    background-color: #f6f6f6;\n    padding-top: 200px;\n}\n\n.logo {\n    font-size: 200px;\n}\n\n.wrapper {\n    padding: 0 50px;\n    max-width: 1200px;\n    text-align: center;\n    margin-left: auto;\n    margin-right: auto;\n    margin-top: 0;\n}\n\n.parent-container {\n    float: left;\n    width: 45%;\n    margin: 20px;\n}\n\n/* Image zoom on hover + Overlay colour */\n\n.parent {\n    width: 100%;\n    margin: 0;\n    height: 300px;\n    border: 1px solid #b0b1e5;\n    border-radius: 2px;\n    overflow: hidden;\n    position: relative;\n    display: inline-block;\n    cursor: pointer;\n}\n\n.child {\n    height: 100%;\n    width: 100%;\n    background-size: cover;\n    background-repeat: no-repeat;\n    -webkit-transition: all .5s;\n    transition: all .5s;\n}\n\n/* Several different images */\n\n.bg-one {\n    background-image: url('quickapp-pro.11195c57ed9408121df9.png');\n}\n\n.bg-two {\n    background-image: url('quickapp-standard.ba781b77c5b942938978.png');\n}\n\n.showcase {\n    margin-bottom: -200px;\n}\n\n.showcase a {\n        display: none;\n        font-size: 35px;\n        color: #ffffff !important;\n        text-align: center;\n        margin: auto;\n        position: absolute;\n        top: 0;\n        left: 0;\n        bottom: 0;\n        right: 0;\n        height: 50px;\n        cursor: pointer;\n        /*text-decoration: none;*/\n    }\n\n.parent:hover .child, .parent:focus .child {\n    -webkit-transform: scale(1.2);\n    transform: scale(1.2);\n}\n\n.parent:hover .child:before, .parent:focus .child:before {\n        display: block;\n    }\n\n.parent:hover a, .parent:focus a {\n    display: block;\n}\n\n.child:before {\n    content: \"\";\n    display: none;\n    height: 100%;\n    width: 100%;\n    position: absolute;\n    top: 0;\n    left: 0;\n    background-color: rgba(52,73,94,0.75);\n}\n\n.more-templates {\n    display: block;\n    color: #17a2b8;\n    background-color: transparent;\n    background-image: none;\n    border-color: #17a2b8;\n    font-size: 16px;\n    margin-top: 10px;\n}\n\n.more-templates:not(:disabled):not(.disabled).active:focus {\n        -webkit-box-shadow: 0 0 0 0.2rem rgba(23, 162, 184, 0.5);\n                box-shadow: 0 0 0 0.2rem rgba(23, 162, 184, 0.5);\n    }\n\n.more-templates:focus, .more-templates.focus {\n        -webkit-box-shadow: 0 0 0 0.2rem rgba(23, 162, 184, 0.5);\n                box-shadow: 0 0 0 0.2rem rgba(23, 162, 184, 0.5);\n    }\n\n.more-templates:not(:disabled):not(.disabled):active, .more-templates:not(:disabled):not(.disabled).active {\n        color: #fff;\n        background-color: #17a2b8;\n        border-color: #17a2b8;\n    }\n\n.more-templates:hover {\n        color: #fff;\n        background-color: #17a2b8;\n        border-color: #17a2b8;\n    }\n\n@media screen and (max-width: 768px) {\n    .col-sm-4 {\n        text-align: center;\n        margin: 25px 0;\n    }\n}\n\n@media screen and (max-width: 992px) {\n    .parent-container {\n        width: 100%;\n        margin: 20px 0px\n    }\n\n    .wrapper {\n        padding: 0 20px;\n    }\n\n    .showcase {\n        margin-bottom: 0;\n    }\n\n    .our-values {\n        padding-top: 0;\n    }\n}\n"
...
module.exports = "<div class=\"container\">\n    <header class=\"pageHeader\">\n        <h3><i class=\"fa fa-info-circle fa-lg page-caption\" aria-hidden=\"true\"></i> {{'pageHeader.About' | translate}}</h3>\n    </header>\n\n    <div [@fadeInOut]>\n        <div class=\"row\">\n            <div class=\"col-md-9\">\n                <h3>Welcome to QuickApp</h3>\n                <p>This application template provides a quick and convenient way to create ASP.NET Core 2.0 / Angular 5 applications</p>\n            </div>\n            <div class=\"col-md-3 contact-us\">\n                <h4>Drop us a line...</h4>\n                <p><span title=\"Follow me on twitter\" class=\"fa fa-twitter fa-fw\"></span> <a class=\"black-anchor\" target=\"_blank\" href=\"https://twitter.com/kommand\">twitter.com/kommand</a></p>\n                <p><span title=\"Drop me a mail\" class=\"fa fa-envelope fa-fw\"></span> <a class=\"black-anchor\" href=\"mailto:info@ebenmonney.com\">info@ebenmonney.com</a></p>\n                <p><span title=\"Website\" class=\"fa fa-globe fa-fw\"></span> <a class=\"black-anchor\" target=\"_blank\" href=\"https://www.ebenmonney.com/contact\">www.ebenmonney.com</a></p>\n            </div>\n        </div>\n\n        <div class=\"showcase\">\n            <div class=\"wrapper\">\n                <div>\n                    <h4 class=\"text-center text-muted\">CHECK OUT THE PREMIUM TEMPLATES BELOW:</h4>\n                </div>\n                <div class=\"parent-container\">\n                    <div class=\"parent\" onclick=\"location.href='https://www.ebenmonney.com/product/quickapp-pro';\">\n                        <div class=\"child bg-one\">\n                            <a href=\"https://www.ebenmonney.com/product/quickapp-pro\">QuickApp PRO</a>\n                        </div>\n                    </div>\n                    <div class=\"text-muted small\">ASP.NET Core 2.0 / IdentityServer 4 / Angular 5 / Angular Material 2 / Angular CLI</div>\n                </div>\n                <div class=\"parent-container push-right\">\n                    <div class=\"parent\" onclick=\"location.href='https://www.ebenmonney.com/product/quickapp-standard';\">\n                        <div class=\"child bg-two\">\n                            <a href=\"https://www.ebenmonney.com/product/quickapp-standard\">QuickApp STANDARD</a>\n                        </div>\n                    </div>\n                    <div class=\"text-muted small\">ASP.NET Core 2.0 / IdentityServer 4 / Angular 5 / Bootstrap 4 / Bootswatch / Angular CLI</div>\n                </div>\n            </div>\n            <div class=\"clearfix\"></div>\n        </div>\n\n        <div class=\"row our-values\">\n            <div class=\"col-sm-4\">\n                <span class=\"fa fa-globe logo\"></span>\n            </div>\n            <div class=\"col-sm-8\">\n                <h2>Our Values</h2>\n                <h4><strong>MISSION:</strong> Quality, Affordable and Easy-to-adopt software resources for all</h4>\n                <p>\n                    <strong>VISION:</strong> It is our desire to boost productivity in your everyday tasks. Time is the most valuable resource anyone has,\n                    that is why we at Eben Monney<sup>&reg;</sup> Solutions wish to provide quality, affordable and easy-to-use software resources, tools and libraries that makes you efficient, and gets you doing more in less time.\n                    <br />\n                    <br />\n                    Productivity, Accessibility and Affordability is at the core of our values\n                </p>\n            </div>\n        </div>\n\n        <div class=\"row\">\n            <div class=\"col-12\">\n                <a href=\"https://www.ebenmonney.com/shop\" target=\"_blank\" class=\"btn btn-default more-templates\"><i class=\"fa fa-shopping-cart\"></i> Get more templates</a>\n            </div>\n        </div>\n\n    </div>\n</div>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_animations__ = __webpack_require__("./src/app/services/animations.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ng2_toasty__ = __webpack_require__("./node_modules/ng2-toasty/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_app_translation_service__ = __webpack_require__("./src/app/services/app-translation.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_local_store_manager_service__ = __webpack_require__("./src/app/services/local-store-manager.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_app_title_service__ = __webpack_require__("./src/app/services/app-title.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_configuration_service__ = __webpack_require__("./src/app/services/configuration.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__models_permission_model__ = __webpack_require__("./src/app/models/permission.model.ts");
...
var alertify = __webpack_require__("./src/app/assets/scripts/alertify.js");
var AppComponent = /** @class */ (function () {
    function AppComponent(storageManager, toastyService, toastyConfig, accountService, alertService, notificationService, appTitleService, authService, translationService, configurations, router) {
        ...
        this.appTitle = "Quick Application";
        this.appLogo = __webpack_require__("./src/app/assets/images/logo.png");
        this.stickyToasties = [];
    ...
    Object.defineProperty(AppComponent.prototype, "canViewProducts", {
        get: function () {
            return this.accountService.userHasPermission(__WEBPACK_IMPORTED_MODULE_11__models_permission_model__["a" /* Permission */].viewProductsPermission); //eg. viewProductsPermission
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(AppComponent.prototype, "canViewPermissions", {
        get: function () {
            return this.accountService.userHasPermission(__WEBPACK_IMPORTED_MODULE_11__models_permission_model__["a" /* Permission */].viewPermissionsPermission);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(AppComponent.prototype, "canViewRolePermissions", {
        get: function () {
            return this.accountService.userHasPermission(__WEBPACK_IMPORTED_MODULE_11__models_permission_model__["a" /* Permission */].viewRolePermissionsPermission);
        },
        enumerable: true,
        configurable: true
    });
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_7__services_local_store_manager_service__["a" /* LocalStoreManager */], __WEBPACK_IMPORTED_MODULE_2_ng2_toasty__["c" /* ToastyService */], __WEBPACK_IMPORTED_MODULE_2_ng2_toasty__["a" /* ToastyConfig */],
...
var BannerDemoComponent = /** @class */ (function () {
    function BannerDemoComponent() {
        this.banner1 = __webpack_require__("./src/app/assets/images/demo/banner1.png");
        this.banner2 = __webpack_require__("./src/app/assets/images/demo/banner2.png");
        this.banner3 = __webpack_require__("./src/app/assets/images/demo/banner3.png");
        this.banner4 = __webpack_require__("./src/app/assets/images/demo/banner4.png");
    }
    BannerDemoComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'banner-demo',
            template: __webpack_require__("./src/app/components/controls/banner-demo.component.html")
        })
    ], BannerDemoComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_app_translation_service__ = __webpack_require__("./src/app/services/app-translation.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_permission_model__ = __webpack_require__("./src/app/models/permission.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_utilities__ = __webpack_require__("./src/app/services/utilities.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
...
var NotificationsViewerComponent = /** @class */ (function () {
    ...
    NotificationsViewerComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("./src/app/components/controls/notifications-viewer.component.html"),
            styles: [__webpack_require__("./src/app/components/controls/notifications-viewer.component.css")]
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_role_model__ = __webpack_require__("./src/app/models/role.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_permission_model__ = __webpack_require__("./src/app/models/permission.model.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
...
var RoleEditorComponent = /** @class */ (function () {
    ...
    RoleEditorComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("./src/app/components/controls/role-editor.component.html"),
            styles: [__webpack_require__("./src/app/components/controls/role-editor.component.css")]
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_app_translation_service__ = __webpack_require__("./src/app/services/app-translation.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_role_permission_service__ = __webpack_require__("./src/app/services/role-permission.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_utilities__ = __webpack_require__("./src/app/services/utilities.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__models_permission_model__ = __webpack_require__("./src/app/models/permission.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__role_editor_component__ = __webpack_require__("./src/app/components/controls/role-editor.component.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
...
var RolesManagementComponent = /** @class */ (function () {
    function RolesManagementComponent(alertService, translationService, rolePermissionService) {
        this.alertService = alertService;
        this.translationService = translationService;
    ...
    RolesManagementComponent.prototype.loadData = function () {
        ...
        this.rolePermissionService.getRolePermission()
            ...
            _this.rolePermissions = results.permissions;
            _this.rowsCache = roles.slice();
            _this.rows = roles.filter(function (r) { return __WEBPACK_IMPORTED_MODULE_5__services_utilities__["a" /* Utilities */].searchNotInArray("0", false, r.roleId + ""); });
            console.log("Except main role: ", _this.rows);
            _this.allPermissions = Array.isArray(results.accessPermissions) ? results.accessPermissions : [results.accessPermissions];
        }, function (error) {
            _this.alertService.stopLoadingMessage();
            _this.loadingIndicator = false;
    ...
    RolesManagementComponent.prototype.managePermission = function (role) {
        ...
        this.assignedPermissions = [];
        this.unassignedPermissions = [];
        this.assignedPermissions = this.rolePermissions.filter(function (r) { return __WEBPACK_IMPORTED_MODULE_5__services_utilities__["a" /* Utilities */].searchArray(role.roleId + "", false, r.roleId + ""); });
        var mainPermissions = this.rolePermissions.filter(function (r) { return __WEBPACK_IMPORTED_MODULE_5__services_utilities__["a" /* Utilities */].searchArray("0", false, r.roleId + ""); });
        for (var i = 0; i < mainPermissions.length; i++) {
            var isExists = false;
            mainPermissions[i].selected = false;
            for (var j = 0; j < this.assignedPermissions.length; j++) {
    ...
    RolesManagementComponent.prototype.saveChanges = function () {
        var _this = this;
        ...
        this.rolePermissionService.saveRolePermission(objSave)
            .subscribe(function (results) {
            if (results.status) {
                _this.statusMessage = "savedSuccessfully!!!";
    ...
    RolesManagementComponent.prototype.moveForward = function () {
        ...
        for (var i = 0; i < this.unassignedPermissions.length; i++) {
            if (this.unassignedPermissions[i].selected != null && this.unassignedPermissions[i].selected) {
                var item = this.unassignedPermissions[i];
        ...
        this.unassignedPermissions = this.unassignedPermissions.filter(function (t) { return __WEBPACK_IMPORTED_MODULE_5__services_utilities__["a" /* Utilities */].searchArray("false", false, (t.selected == null ? "false" : t.selected + "")); });
    };
    RolesManagementComponent.prototype.moveAllForward = function () {
        console.log("Selected Permission: ", this.unassignedPermissions);
        for (var i = 0; i < this.unassignedPermissions.length; i++) {
            var item = this.unassignedPermissions[i];
            this.assignedPermissions[this.assignedPermissions.length] = { permissionId: item.permissionId, permission: item.permission, roleId: this.rolePermission.roleId };
    ...
    RolesManagementComponent.prototype.moveBackward = function () {
        console.log("Selected Permission: ", this.unassignedPermissions);
        for (var i = 0; i < this.assignedPermissions.length; i++) {
            if (this.assignedPermissions[i].selected != null && this.assignedPermissions[i].selected) {
                var item = this.assignedPermissions[i];
        ...
        this.assignedPermissions = this.assignedPermissions.filter(function (t) { return __WEBPACK_IMPORTED_MODULE_5__services_utilities__["a" /* Utilities */].searchArray("false", false, (t.selected == null ? "false" : t.selected + "")); });
    };
    RolesManagementComponent.prototype.moveAllBackward = function () {
        console.log("Selected Permission: ", this.unassignedPermissions);
        for (var i = 0; i < this.assignedPermissions.length; i++) {
            var item = this.assignedPermissions[i];
 ...
 */
    RolesManagementComponent.prototype.closeModel = function () {
        this.editorModal.hide();
    };
    Object.defineProperty(RolesManagementComponent.prototype, "canManageRoles", {
        get: function () {
            return this.rolePermissionService.userHasPermission(__WEBPACK_IMPORTED_MODULE_6__models_permission_model__["a" /* Permission */].manageRolesPermission);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RolesManagementComponent.prototype, "canMoveForward", {
        get: function () {
            return this.rolePermissionService.userHasPermission(__WEBPACK_IMPORTED_MODULE_6__models_permission_model__["a" /* Permission */].moveForwardPermission);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RolesManagementComponent.prototype, "canMoveAllForward", {
        get: function () {
            return this.rolePermissionService.userHasPermission(__WEBPACK_IMPORTED_MODULE_6__models_permission_model__["a" /* Permission */].moveAllForwardPermission);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RolesManagementComponent.prototype, "canMoveBackward", {
        get: function () {
            return this.rolePermissionService.userHasPermission(__WEBPACK_IMPORTED_MODULE_6__models_permission_model__["a" /* Permission */].moveBackwardPermission);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RolesManagementComponent.prototype, "canMoveAllBackward", {
        get: function () {
            return this.rolePermissionService.userHasPermission(__WEBPACK_IMPORTED_MODULE_6__models_permission_model__["a" /* Permission */].moveAllBackwardPermission);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RolesManagementComponent.prototype, "canSaveChanges", {
        get: function () {
            return this.rolePermissionService.userHasPermission(__WEBPACK_IMPORTED_MODULE_6__models_permission_model__["a" /* Permission */].saveChangesPermission);
        },
        enumerable: true,
        configurable: true
    });
    ...
    __decorate([
        ...
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_7__role_editor_component__["a" /* RoleEditorComponent */])
    ], RolesManagementComponent.prototype, "roleEditor", void 0);
    RolesManagementComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'roles-management',
            template: __webpack_require__("./src/app/components/controls/roles-management.component.html"),
            styles: [__webpack_require__("./src/app/components/controls/roles-management.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_alert_service__["a" /* AlertService */], __WEBPACK_IMPORTED_MODULE_3__services_app_translation_service__["a" /* AppTranslationService */], __WEBPACK_IMPORTED_MODULE_4__services_role_permission_service__["a" /* RolePermissionService */]])
...
var SearchBoxComponent = /** @class */ (function () {
    ...
    SearchBoxComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'search-box',
            template: __webpack_require__("./src/app/components/controls/search-box.component.html"),
            styles: [__webpack_require__("./src/app/components/controls/search-box.component.css")]
        })
    ], SearchBoxComponent);
...
var StatisticsDemoComponent = /** @class */ (function () {
    ...
    StatisticsDemoComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("./src/app/components/controls/statistics-demo.component.html"),
            styles: [__webpack_require__("./src/app/components/controls/statistics-demo.component.css")]
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_alert_service__ = __webpack_require__("./src/app/services/alert.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_app_translation_service__ = __webpack_require__("./src/app/services/app-translation.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_local_store_manager_service__ = __webpack_require__("./src/app/services/local-store-manager.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_utilities__ = __webpack_require__("./src/app/services/utilities.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
...
var TodoDemoComponent = /** @class */ (function () {
    ...
    TodoDemoComponent = TodoDemoComponent_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'todo-demo',
            template: __webpack_require__("./src/app/components/controls/todo-demo.component.html"),
            styles: [__webpack_require__("./src/app/components/controls/todo-demo.component.css")]
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_alert_service__ = __webpack_require__("./src/app/services/alert.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_account_service__ = __webpack_require__("./src/app/services/account.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_utilities__ = __webpack_require__("./src/app/services/utilities.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_user_model__ = __webpack_require__("./src/app/models/user.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_user_edit_model__ = __webpack_require__("./src/app/models/user-edit.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__models_role_model__ = __webpack_require__("./src/app/models/role.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__models_permission_model__ = __webpack_require__("./src/app/models/permission.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ngx_cookie_service__ = __webpack_require__("./node_modules/ngx-cookie-service/index.js");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
...
var UserInfoComponent = /** @class */ (function () {
    function UserInfoComponent(alertService, accountService, cookieService) {
        this.alertService = alertService;
        this.accountService = accountService;
    ...
    UserInfoComponent.prototype.loadCurrentUserData = function () {
        ...
        if (this.canViewAllRoles) {
            ...
            this.accountService.getUser().subscribe(function (user) {
                _this.onCurrentUserDataLoadSuccessful(user, user.roles.map(function (x) { return new __WEBPACK_IMPORTED_MODULE_6__models_role_model__["a" /* Role */](x); }));
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('rolesSelector'),
        __metadata("design:type", Object)
    ], UserInfoComponent.prototype, "rolesSelector", void 0);
    UserInfoComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'user-info',
            template: __webpack_require__("./src/app/components/controls/user-info.component.html"),
            styles: [__webpack_require__("./src/app/components/controls/user-info.component.css")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__services_alert_service__["a" /* AlertService */], __WEBPACK_IMPORTED_MODULE_2__services_account_service__["a" /* AccountService */], __WEBPACK_IMPORTED_MODULE_8_ngx_cookie_service__["a" /* CookieService */]])
    ], UserInfoComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_app_translation_service__ = __webpack_require__("./src/app/services/app-translation.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__directives_bootstrap_select_directive__ = __webpack_require__("./src/app/directives/bootstrap-select.directive.ts");
...
var UserPreferencesComponent = /** @class */ (function () {
    ...
    UserPreferencesComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("./src/app/components/controls/user-preferences.component.html"),
            styles: [__webpack_require__("./src/app/components/controls/user-preferences.component.css")]
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__models_role_model__ = __webpack_require__("./src/app/models/role.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__models_permission_model__ = __webpack_require__("./src/app/models/permission.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__user_info_component__ = __webpack_require__("./src/app/components/controls/user-info.component.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
...
var UsersManagementComponent = /** @class */ (function () {
    ...
    UsersManagementComponent.prototype.addNewUserToList = function () {
        if (this.sourceUser) {
            ...
            if (sourceIndex > -1)
                __WEBPACK_IMPORTED_MODULE_5__services_utilities__["a" /* Utilities */].moveArrayItem(this.rowsCache, sourceIndex, 0);
            sourceIndex = this.rows.indexOf(this.sourceUser, 0);
            if (sourceIndex > -1)
                __WEBPACK_IMPORTED_MODULE_5__services_utilities__["a" /* Utilities */].moveArrayItem(this.rows, sourceIndex, 0);
    ...
    UsersManagementComponent.prototype.loadData = function () {
        ...
        if (this.canViewRoles) {
            ...
            this.accountService.getUsers().subscribe(function (users) { return _this.onDataLoadSuccessful(users, _this.accountService.currentUser.roles.map(function (x) { return new __WEBPACK_IMPORTED_MODULE_7__models_role_model__["a" /* Role */](x); })); }, function (error) { return _this.onDataLoadFailed(error); });
        }
    };
    ...
    Object.defineProperty(UsersManagementComponent.prototype, "canAssignRoles", {
        get: function () {
            return this.accountService.userHasPermission(__WEBPACK_IMPORTED_MODULE_8__models_permission_model__["a" /* Permission */].assignRolesPermission);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UsersManagementComponent.prototype, "canViewRoles", {
        get: function () {
            return this.accountService.userHasPermission(__WEBPACK_IMPORTED_MODULE_8__models_permission_model__["a" /* Permission */].viewRolesPermission);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(UsersManagementComponent.prototype, "canManageUsers", {
        get: function () {
            return this.accountService.userHasPermission(__WEBPACK_IMPORTED_MODULE_8__models_permission_model__["a" /* Permission */].manageUsersPermission);
        },
        enumerable: true,
        configurable: true
    });
    ...
    __decorate([
        ...
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_9__user_info_component__["a" /* UserInfoComponent */])
    ], UsersManagementComponent.prototype, "userEditor", void 0);
    UsersManagementComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'users-management',
            template: __webpack_require__("./src/app/components/controls/users-management.component.html"),
            styles: [__webpack_require__("./src/app/components/controls/users-management.component.css")]
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_alert_service__ = __webpack_require__("./src/app/services/alert.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_auth_service__ = __webpack_require__("./src/app/services/auth.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_configuration_service__ = __webpack_require__("./src/app/services/configuration.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__services_utilities__ = __webpack_require__("./src/app/services/utilities.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_user_login_model__ = __webpack_require__("./src/app/models/user-login.model.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
        ...
        this.authService.login(this.userLogin.email, this.userLogin.password, this.userLogin.rememberMe)
            ...
            if (__WEBPACK_IMPORTED_MODULE_4__services_utilities__["a" /* Utilities */].checkNoNetwork(error)) {
                ...
                if (errorMessage)
                    ...
                    var errorMessage_1 = __WEBPACK_IMPORTED_MODULE_4__services_utilities__["a" /* Utilities */].findHttpResponseMessage("error", error);
                    if (errorMessage_1) {
                        _this.alertService.showStickyMessage("Unable to login", errorMessage_1, __WEBPACK_IMPORTED_MODULE_1__services_alert_service__["c" /* MessageSeverity */].error, error);
                    }
                    else {
...
module.exports = "<div class=\"container\">\n    <header class=\"pageHeader\">\n        <h3><i class=\"fa fa-truck fa-lg page-caption\" aria-hidden=\"true\"></i> {{'pageHeader.Permissions' | translate}}</h3>\n    </header>\n\n    <div [@fadeInOut]>\n        <span class=\"text-muted\">-- Sample Page --</span>\n    </div>\n</div>\n"
...
var PermissionsComponent = /** @class */ (function () {
    ...
    PermissionsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("./src/app/components/permissions/permissions.component.html"),
            styles: [__webpack_require__("./src/app/components/permissions/permissions.component.css")],
            animations: [__WEBPACK_IMPORTED_MODULE_1__services_animations__["a" /* fadeInOut */]]
        })
...
/***/ "./src/app/components/rolePermissions/rolePermissions.component.css":
/***/ (function(module, exports) {
...
/***/ "./src/app/components/rolePermissions/rolePermissions.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"container\">\n    <header class=\"pageHeader\">\n        <h3><i class=\"fa fa-handshake-o fa-lg page-caption\" aria-hidden=\"true\"></i> {{'pageHeader.RolePermissions' | translate}}</h3>\n    </header>\n\n    <div [@fadeInOut]>\n        <!---- Sample Page Content ---->\n        <roles-management verticalScrollbar=\"true\"></roles-management>\n    </div>\n</div>\n"

/***/ }),

/***/ "./src/app/components/rolePermissions/rolePermissions.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RolePermissionsComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_animations__ = __webpack_require__("./src/app/services/animations.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
...
var RolePermissionsComponent = /** @class */ (function () {
    ...
    RolePermissionsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("./src/app/components/rolePermissions/rolePermissions.component.html"),
            styles: [__webpack_require__("./src/app/components/rolePermissions/rolePermissions.component.css")],
            animations: [__WEBPACK_IMPORTED_MODULE_1__services_animations__["a" /* fadeInOut */]]
        })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_animations__ = __webpack_require__("./src/app/services/animations.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__directives_bootstrap_tab_directive__ = __webpack_require__("./src/app/directives/bootstrap-tab.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_account_service__ = __webpack_require__("./src/app/services/account.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__models_permission_model__ = __webpack_require__("./src/app/models/permission.model.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
...
var SettingsComponent = /** @class */ (function () {
    ...
    Object.defineProperty(SettingsComponent.prototype, "canViewUsers", {
        get: function () {
            return this.accountService.userHasPermission(__WEBPACK_IMPORTED_MODULE_6__models_permission_model__["a" /* Permission */].viewUsersPermission);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(SettingsComponent.prototype, "canViewRoles", {
        get: function () {
            return this.accountService.userHasPermission(__WEBPACK_IMPORTED_MODULE_6__models_permission_model__["a" /* Permission */].viewRolesPermission);
        },
        enumerable: true,
        configurable: true
    });
    ...
    SettingsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */], __WEBPACK_IMPORTED_MODULE_5__services_account_service__["a" /* AccountService */]])
    ], SettingsComponent);
...
var BootstrapDatepickerDirective = /** @class */ (function () {
    function BootstrapDatepickerDirective(el) {
        ...
        this.changedSubscription = __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].fromEvent($(this.el.nativeElement), 'change').subscribe(function (e) { return setTimeout(function () { return _this.ngModelChange.emit(e.target.value); }); });
        this.shownSubscription = __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].fromEvent($(this.el.nativeElement), 'show').subscribe(function (e) { return _this._isShown = true; });
        this.hiddenSubscription = __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].fromEvent($(this.el.nativeElement), 'hide').subscribe(function (e) { return _this._isShown = false; });
    }
...
var BootstrapSelectDirective = /** @class */ (function () {
    function BootstrapSelectDirective(el) {
        ...
        this.changedSubscription = __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].fromEvent($(this.el.nativeElement), 'changed.bs.select').subscribe(function (e) { return setTimeout(function () { return _this.ngModelChange.emit(_this.selected); }); });
        this.shownSubscription = __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].fromEvent($(this.el.nativeElement), 'shown.bs.select').subscribe(function (e) { return setTimeout(function () { return _this.shown.emit(); }); });
        this.hiddenSubscription = __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].fromEvent($(this.el.nativeElement), 'hidden.bs.select').subscribe(function (e) { return setTimeout(function () { return _this.hidden.emit(); }); });
    }
...
var BootstrapTabDirective = /** @class */ (function () {
    function BootstrapTabDirective(el, zone) {
        ...
        this.tabShownSubscription = __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].fromEvent($(this.el.nativeElement), 'show.bs.tab')
            .subscribe(function (e) {
            _this.runInZone(function () { return _this.showBSTab.emit({ type: e.type, target: e.target, relatedTarget: e.relatedTarget }); });
        });
        this.tabHiddenSubscription = __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].fromEvent($(this.el.nativeElement), 'hidden.bs.tab')
            .subscribe(function (e) {
...
var BootstrapToggleDirective = /** @class */ (function () {
    function BootstrapToggleDirective(el) {
        ...
        this.el = el;
        this.ngModelChange = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        this.checkedSubscription = __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].fromEvent($(this.el.nativeElement), 'change')
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__services_utilities__ = __webpack_require__("./src/app/services/utilities.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
...
var Permission = /** @class */ (function () {
    ...
    Permission.viewProductsPermission = "view.products";
    Permission.viewPermissionsPermission = "view.permissions";
    Permission.viewRolePermissionsPermission = "role.permissions";
    ...
    //role-permission
    Permission.moveForwardPermission = "role-forward";
    Permission.moveAllForwardPermission = "role-backward";
    Permission.moveBackwardPermission = "role-forward-all";
    Permission.moveAllBackwardPermission = "role-backward-all";
    Permission.saveChangesPermission = "role-save-changes";
    return Permission;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__endpoint_factory_service__ = __webpack_require__("./src/app/services/endpoint-factory.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__configuration_service__ = __webpack_require__("./src/app/services/configuration.service.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
...
var AccountEndpoint = /** @class */ (function (_super) {
    ...
    function AccountEndpoint(http, configurations, injector, cookieService) {
        var _this = _super.call(this, http, configurations, injector, cookieService) || this;
        _this._usersUrl = "/api/get-users";
        _this._userByUserNameUrl = "/api/account/users/username";
        _this._currentUserUrl = "/api/get-user";
        _this._currentUserPreferencesUrl = "/api/account/users/me/preferences";
        _this._unblockUserUrl = "/api/account/users/unblock";
        _this._rolesUrl = "/api/get-roles";
    ...
    AccountEndpoint = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_5__configuration_service__["a" /* ConfigurationService */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["Injector"], __WEBPACK_IMPORTED_MODULE_3_ngx_cookie_service__["a" /* CookieService */]])
    ], AccountEndpoint);
    return AccountEndpoint;
}(__WEBPACK_IMPORTED_MODULE_4__endpoint_factory_service__["a" /* EndpointFactory */]));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__account_endpoint_service__ = __webpack_require__("./src/app/services/account-endpoint.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__auth_service__ = __webpack_require__("./src/app/services/auth.service.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
...
var AccountService = /** @class */ (function () {
    function AccountService(router, http, authService, accountEndpoint) {
        ...
        this._rolesChanged = new __WEBPACK_IMPORTED_MODULE_4_rxjs_Subject__["a" /* Subject */]();
    }
    ...
    AccountService.prototype.getUserAndRoles = function (userId) {
        return __WEBPACK_IMPORTED_MODULE_3_rxjs_Observable__["a" /* Observable */].forkJoin(this.accountEndpoint.getUserEndpoint(userId), this.accountEndpoint.getRolesEndpoint());
    };
    ...
    AccountService.prototype.getUsersAndRoles = function (page, pageSize) {
        return __WEBPACK_IMPORTED_MODULE_3_rxjs_Observable__["a" /* Observable */].forkJoin(this.accountEndpoint.getUsersEndpoint(page, pageSize), this.accountEndpoint.getRolesEndpoint());
    };
    ...
    AccountService.prototype.getRolesAndPermissions = function (page, pageSize) {
        return __WEBPACK_IMPORTED_MODULE_3_rxjs_Observable__["a" /* Observable */].forkJoin(this.accountEndpoint.getRolesEndpoint(page, pageSize), this.accountEndpoint.getPermissionsEndpoint());
    };
    ...
    AccountService = AccountService_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["d" /* Router */], __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_9__auth_service__["a" /* AuthService */],
...
var AlertService = /** @class */ (function () {
    function AlertService() {
        this.messages = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__["a" /* Subject */]();
        this.stickyMessages = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__["a" /* Subject */]();
        this.dialogs = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__["a" /* Subject */]();
    ...
    AlertService.prototype.showMessage = function (data, separatorOrDetail, severity) {
        ...
        if (data instanceof __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["g" /* HttpResponseBase */]) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utilities__ = __webpack_require__("./src/app/services/utilities.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
...
var AppTranslationService = /** @class */ (function () {
    function AppTranslationService(translate) {
        ...
        this._languageChanged = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Subject__["a" /* Subject */]();
...
var TranslateLanguageLoader = /** @class */ (function () {
    ...
    TranslateLanguageLoader.prototype.getTranslation = function (lang) {
        ...
        switch (lang) {
            case "en":
                return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].of(__webpack_require__("./src/app/assets/locale/en.json"));
            case "fr":
                return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].of(__webpack_require__("./src/app/assets/locale/fr.json"));
            case "de":
                return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].of(__webpack_require__("./src/app/assets/locale/de.json"));
            case "pt":
                return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].of(__webpack_require__("./src/app/assets/locale/pt.json"));
            case "ar":
                return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].of(__webpack_require__("./src/app/assets/locale/ar.json"));
            case "ko":
                return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].of(__webpack_require__("./src/app/assets/locale/ko.json"));
            default:
        }
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__local_store_manager_service__ = __webpack_require__("./src/app/services/local-store-manager.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__endpoint_factory_service__ = __webpack_require__("./src/app/services/endpoint-factory.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__configuration_service__ = __webpack_require__("./src/app/services/configuration.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__db_Keys__ = __webpack_require__("./src/app/services/db-Keys.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__jwt_helper__ = __webpack_require__("./src/app/services/jwt-helper.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__utilities__ = __webpack_require__("./src/app/services/utilities.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__models_user_model__ = __webpack_require__("./src/app/models/user.model.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
...
var AuthService = /** @class */ (function () {
    function AuthService(router, configurations, endpointFactory, localStorage, cookieService) {
        this.router = router;
        this.configurations = configurations;
        ...
        this._loginStatus = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__["a" /* Subject */]();
    ...
    AuthService.prototype.redirectLoginUser = function () {
        var redirect = this.loginRedirectUrl && this.loginRedirectUrl != '/' && this.loginRedirectUrl != __WEBPACK_IMPORTED_MODULE_7__configuration_service__["a" /* ConfigurationService */].defaultHomeUrl ? this.loginRedirectUrl : this.homeUrl;
        this.loginRedirectUrl = null;
        var urlParamsAndFragment = __WEBPACK_IMPORTED_MODULE_10__utilities__["a" /* Utilities */].splitInTwo(redirect, '#');
        var urlAndParams = __WEBPACK_IMPORTED_MODULE_10__utilities__["a" /* Utilities */].splitInTwo(urlParamsAndFragment.firstPart, '?');
        var navigationExtras = {
            fragment: urlParamsAndFragment.secondPart,
            queryParams: __WEBPACK_IMPORTED_MODULE_10__utilities__["a" /* Utilities */].getQueryParamsFromString(urlAndParams.secondPart),
    ...
    AuthService.prototype.reLogin = function () {
        this.localStorage.deleteData(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].TOKEN_EXPIRES_IN);
    ...
    AuthService.prototype.processLoginResponse = function (response, rememberMe) {
        ...
        var jwtHelper = new __WEBPACK_IMPORTED_MODULE_9__jwt_helper__["a" /* JwtHelper */]();
        //let decodedIdToken = <IdToken>jwtHelper.decodeToken(response.id_token);
        var permissions = Array.isArray(response.user.permission) ? response.user.permission : [response.user.permission];
        var decodedIdToken = response.user;
        if (!this.isLoggedIn)
            this.configurations.import(decodedIdToken.configuration);
        this.cookieService.set('emailId', decodedIdToken.emailid);
        var user = new __WEBPACK_IMPORTED_MODULE_11__models_user_model__["a" /* User */](decodedIdToken.sub, decodedIdToken.name, decodedIdToken.fullname, decodedIdToken.emailid, decodedIdToken.jobtitle, decodedIdToken.phone, Array.isArray(decodedIdToken.role) ? decodedIdToken.role : [decodedIdToken.role]);
        user.isEnabled = true;
    ...
    AuthService.prototype.saveUserDetails = function (user, permissions, accessToken, idToken, refreshToken, expiresIn, rememberMe) {
        if (rememberMe) {
            this.localStorage.savePermanentData(accessToken, __WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].ACCESS_TOKEN);
            this.localStorage.savePermanentData(idToken, __WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].ID_TOKEN);
            this.localStorage.savePermanentData(refreshToken, __WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].REFRESH_TOKEN);
            this.localStorage.savePermanentData(expiresIn, __WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].TOKEN_EXPIRES_IN);
            this.localStorage.savePermanentData(permissions, __WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].USER_PERMISSIONS);
            this.localStorage.savePermanentData(user, __WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].CURRENT_USER);
        }
        else {
            this.localStorage.saveSyncedSessionData(accessToken, __WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].ACCESS_TOKEN);
            this.localStorage.saveSyncedSessionData(idToken, __WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].ID_TOKEN);
            this.localStorage.saveSyncedSessionData(refreshToken, __WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].REFRESH_TOKEN);
            this.localStorage.saveSyncedSessionData(expiresIn, __WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].TOKEN_EXPIRES_IN);
            this.localStorage.saveSyncedSessionData(permissions, __WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].USER_PERMISSIONS);
            this.localStorage.saveSyncedSessionData(user, __WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].CURRENT_USER);
        }
        this.localStorage.savePermanentData(rememberMe, __WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].REMEMBER_ME);
    };
    AuthService.prototype.logout = function () {
        this.localStorage.deleteData(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].ACCESS_TOKEN);
        this.localStorage.deleteData(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].ID_TOKEN);
        this.localStorage.deleteData(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].REFRESH_TOKEN);
        this.localStorage.deleteData(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].TOKEN_EXPIRES_IN);
        this.localStorage.deleteData(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].USER_PERMISSIONS);
        this.localStorage.deleteData(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].CURRENT_USER);
        this.configurations.clearLocalChanges();
        this.reevaluateLoginStatus();
    };
    AuthService.prototype.reevaluateLoginStatus = function (currentUser) {
        var _this = this;
        var user = currentUser || this.localStorage.getDataObject(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].CURRENT_USER);
    ...
    Object.defineProperty(AuthService.prototype, "currentUser", {
        get: function () {
            var user = this.localStorage.getDataObject(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].CURRENT_USER);
            this.reevaluateLoginStatus(user);
            return user;
        },
        enumerable: true,
    ...
    Object.defineProperty(AuthService.prototype, "userPermissions", {
        get: function () {
            return this.localStorage.getDataObject(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].USER_PERMISSIONS) || [];
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(AuthService.prototype, "accessToken", {
        get: function () {
            this.reevaluateLoginStatus();
            return this.localStorage.getData(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].ACCESS_TOKEN);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(AuthService.prototype, "accessTokenExpiryDate", {
        get: function () {
            this.reevaluateLoginStatus();
            return this.localStorage.getDataObject(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].TOKEN_EXPIRES_IN, true);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(AuthService.prototype, "idToken", {
        get: function () {
            this.reevaluateLoginStatus();
            return this.localStorage.getData(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].ID_TOKEN);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(AuthService.prototype, "refreshToken", {
        get: function () {
            this.reevaluateLoginStatus();
            return this.localStorage.getData(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].REFRESH_TOKEN);
        },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(AuthService.prototype, "rememberMe", {
        get: function () {
            return this.localStorage.getDataObject(__WEBPACK_IMPORTED_MODULE_8__db_Keys__["a" /* DBkeys */].REMEMBER_ME) == true;
        },
        enumerable: true,
        configurable: true
    });
    AuthService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["d" /* Router */], __WEBPACK_IMPORTED_MODULE_7__configuration_service__["a" /* ConfigurationService */], __WEBPACK_IMPORTED_MODULE_6__endpoint_factory_service__["a" /* EndpointFactory */], __WEBPACK_IMPORTED_MODULE_5__local_store_manager_service__["a" /* LocalStoreManager */], __WEBPACK_IMPORTED_MODULE_4_ngx_cookie_service__["a" /* CookieService */]])
    ], AuthService);
    return AuthService;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app_translation_service__ = __webpack_require__("./src/app/services/app-translation.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__local_store_manager_service__ = __webpack_require__("./src/app/services/local-store-manager.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__db_Keys__ = __webpack_require__("./src/app/services/db-Keys.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utilities__ = __webpack_require__("./src/app/services/utilities.ts");
...
var ConfigurationService = /** @class */ (function () {
    function ConfigurationService(localStorage, translationService) {
        ...
        this.baseUrl = "https://test-quickapp-nodejs.azurewebsites.net";
        this.loginUrl = __WEBPACK_IMPORTED_MODULE_5__environments_environment__["a" /* environment */].loginUrl;
        this.fallbackBaseUrl = "https://test-quickapp-nodejs.azurewebsites.net";
        //***End of defaults***  
        this._language = null;
        this._homeUrl = null;
        this._theme = null;
    ...
    ConfigurationService.appVersion = "2.5.3";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ngx_cookie_service__ = __webpack_require__("./node_modules/ngx-cookie-service/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__auth_service__ = __webpack_require__("./src/app/services/auth.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__configuration_service__ = __webpack_require__("./src/app/services/configuration.service.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
...
var EndpointFactory = /** @class */ (function () {
    function EndpointFactory(http, configurations, injector, cookieService) {
        this.http = http;
        this.configurations = configurations;
    ...
    Object.defineProperty(EndpointFactory.prototype, "authService", {
        get: function () {
            if (!this._authService)
                this._authService = this.injector.get(__WEBPACK_IMPORTED_MODULE_9__auth_service__["a" /* AuthService */]);
    ...
    EndpointFactory.prototype.getRequestHeaders = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({
            ...
            'App-Version': __WEBPACK_IMPORTED_MODULE_10__configuration_service__["a" /* ConfigurationService */].appVersion,
        ...
        if (error.status == 401) {
            ...
            return this.authService.refreshLogin()
                ...
                if (refreshLoginError.status == 401 || (refreshLoginError.url && refreshLoginError.url.toLowerCase().includes(_this.loginUrl.toLowerCase()))) {
                    ...
                    return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].throw('session expired');
                }
                else {
                    return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].throw(refreshLoginError || 'server error');
                }
            });
        }
        if (error.url && error.url.toLowerCase().includes(this.loginUrl.toLowerCase())) {
            this.authService.reLogin();
            return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].throw((error.error && error.error.error_description) ? "session expired (" + error.error.error_description + ")" : 'session expired');
        }
        else {
    ...
    EndpointFactory.prototype.pauseTask = function (continuation) {
        if (!this.taskPauser)
            this.taskPauser = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Subject__["a" /* Subject */]();
        return this.taskPauser.switchMap(function (continueOp) {
            return continueOp ? continuation() : __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].throw('session expired');
        });
    };
    ...
    EndpointFactory = EndpointFactory_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_10__configuration_service__["a" /* ConfigurationService */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["Injector"], __WEBPACK_IMPORTED_MODULE_8_ngx_cookie_service__["a" /* CookieService */]])
    ], EndpointFactory);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utilities__ = __webpack_require__("./src/app/services/utilities.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
...
var LocalStoreManager = /** @class */ (function () {
    function LocalStoreManager() {
        var _this = this;
        this.syncKeys = [];
        this.initEvent = new __WEBPACK_IMPORTED_MODULE_1_rxjs_Subject__["a" /* Subject */]();
...
var NotificationEndpoint = /** @class */ (function () {
    ...
    NotificationEndpoint.prototype.getNotificationEndpoint = function (notificationId) {
        ...
        return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["a" /* Observable */].of(response.body);
    };
    ...
    NotificationEndpoint.prototype.createResponse = function (body, status) {
        return new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["f" /* HttpResponse */]({ body: body, status: status });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__notification_endpoint_service__ = __webpack_require__("./src/app/services/notification-endpoint.service.ts");
...
var NotificationService = /** @class */ (function () {
    ...
    NotificationService.prototype.getNotification = function (notificationId) {
        return this.notificationEndpoint.getNotificationEndpoint(notificationId)
            .map(function (response) { return __WEBPACK_IMPORTED_MODULE_7__models_notification_model__["a" /* Notification */].Create(response); });
    };
    ...
    NotificationService.prototype.getNewNotificationsPeriodically = function () {
        var _this = this;
        return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["a" /* Observable */].interval(10000)
            .startWith(0)
            .flatMap(function () {
    ...
    NotificationService.prototype.deleteNotification = function (notificationOrNotificationId) {
        ...
        if (typeof notificationOrNotificationId === 'number' || notificationOrNotificationId instanceof Number) {
            return this.notificationEndpoint.getDeleteNotificationEndpoint(notificationOrNotificationId)
                ...
                return __WEBPACK_IMPORTED_MODULE_7__models_notification_model__["a" /* Notification */].Create(response);
            });
        }
        else {
    ...
    NotificationService.prototype.getNotificationsFromResponse = function (response) {
        ...
        for (var i in response) {
            notifications[i] = __WEBPACK_IMPORTED_MODULE_7__models_notification_model__["a" /* Notification */].Create(response[i]);
        }
...
/***/ "./src/app/services/role-permission-endpoint.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RolePermissionEndpoint; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common_http__ = __webpack_require__("./node_modules/@angular/common/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__ = __webpack_require__("./node_modules/rxjs/_esm5/add/operator/map.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_cookie_service__ = __webpack_require__("./node_modules/ngx-cookie-service/index.js");
...
var RolePermissionEndpoint = /** @class */ (function (_super) {
    __extends(RolePermissionEndpoint, _super);
    function RolePermissionEndpoint(http, configurations, injector, cookieService) {
        var _this = _super.call(this, http, configurations, injector, cookieService) || this;
        _this._rolePermissionUrl = "/api/get-role-permissions";
        _this._saverolePermissionUrl = "/api/save-role-permissions";
        _this._userByUserNameUrl = "/api/account/users/username";
    ...
    Object.defineProperty(RolePermissionEndpoint.prototype, "rolePermissionsUrl", {
        get: function () { return this.configurations.baseUrl + this._rolePermissionUrl; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RolePermissionEndpoint.prototype, "savePermissionsUrl", {
        get: function () { return this.configurations.baseUrl + this._saverolePermissionUrl; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RolePermissionEndpoint.prototype, "userByUserNameUrl", {
        get: function () { return this.configurations.baseUrl + this._userByUserNameUrl; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RolePermissionEndpoint.prototype, "currentUserUrl", {
        get: function () { return this.configurations.baseUrl + this._currentUserUrl; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RolePermissionEndpoint.prototype, "currentUserPreferencesUrl", {
        get: function () { return this.configurations.baseUrl + this._currentUserPreferencesUrl; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RolePermissionEndpoint.prototype, "unblockUserUrl", {
        get: function () { return this.configurations.baseUrl + this._unblockUserUrl; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RolePermissionEndpoint.prototype, "rolesUrl", {
        get: function () { return this.configurations.baseUrl + this._rolesUrl; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RolePermissionEndpoint.prototype, "roleByRoleNameUrl", {
        get: function () { return this.configurations.baseUrl + this._roleByRoleNameUrl; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RolePermissionEndpoint.prototype, "permissionsUrl", {
        get: function () { return this.configurations.baseUrl + this._permissionsUrl; },
        enumerable: true,
        configurable: true
    });
    RolePermissionEndpoint.prototype.getRolePermissionEndpoint = function (roleId) {
        var _this = this;
        var endpointUrl = roleId ? this._rolePermissionUrl + "/" + roleId : this.rolePermissionsUrl;
        return this.http.get(endpointUrl, this.getRequestHeaders())
            .catch(function (error) {
            return _this.handleError(error, function () { return _this.getRolePermissionEndpoint(roleId); });
        });
    };
    RolePermissionEndpoint.prototype.saveRolePermissionEndpoint = function (rolePermission) {
        var _this = this;
        var endpointUrl = this.savePermissionsUrl;
        console.log("Save Role Permission: ", rolePermission);
        return this.http.post(endpointUrl, JSON.stringify(rolePermission), this.getRequestHeaders())
            .catch(function (error) {
            return _this.handleError(error, function () { return _this.saveRolePermissionEndpoint(rolePermission); });
        });
    };
    RolePermissionEndpoint = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_5__configuration_service__["a" /* ConfigurationService */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["Injector"], __WEBPACK_IMPORTED_MODULE_3_ngx_cookie_service__["a" /* CookieService */]])
    ], RolePermissionEndpoint);
    return RolePermissionEndpoint;
}(__WEBPACK_IMPORTED_MODULE_4__endpoint_factory_service__["a" /* EndpointFactory */]));
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RolePermissionService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common_http__ = __webpack_require__("./node_modules/@angular/common/esm5/http.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_Subject__ = __webpack_require__("./node_modules/rxjs/_esm5/Subject.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__role_permission_endpoint_service__ = __webpack_require__("./src/app/services/role-permission-endpoint.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__auth_service__ = __webpack_require__("./src/app/services/auth.service.ts");
// ====================================================
// More Templates: https://www.ebenmonney.com/templates
// Email: support@ebenmonney.com
// ====================================================
...
var RolePermissionService = /** @class */ (function () {
    function RolePermissionService(router, http, authService, rolePermissionEndpoint) {
        this.router = router;
        this.http = http;
        this.authService = authService;
        this.rolePermissionEndpoint = rolePermissionEndpoint;
        this._rolesChanged = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Subject__["a" /* Subject */]();
    }
    RolePermissionService.prototype.userHasPermission = function (permissionValue) {
        return this.permissions.some(function (p) { return p == permissionValue; });
    };
    RolePermissionService.prototype.getRolePermission = function (roleId) {
        return this.rolePermissionEndpoint.getRolePermissionEndpoint(roleId);
    };
    RolePermissionService.prototype.saveRolePermission = function (rolePermission) {
        return this.rolePermissionEndpoint.saveRolePermissionEndpoint(rolePermission);
    };
    Object.defineProperty(RolePermissionService.prototype, "permissions", {
        get: function () {
            return this.authService.userPermissions;
        },
        enumerable: true,
    ...
    Object.defineProperty(RolePermissionService.prototype, "currentUser", {
        get: function () {
            return this.authService.currentUser;
        },
        enumerable: true,
    ...
    RolePermissionService.roleAddedOperation = "add";
    RolePermissionService.roleDeletedOperation = "delete";
    RolePermissionService.roleModifiedOperation = "modify";
    RolePermissionService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["d" /* Router */], __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_8__auth_service__["a" /* AuthService */],
            __WEBPACK_IMPORTED_MODULE_7__role_permission_endpoint_service__["a" /* RolePermissionEndpoint */]])
...
var Utilities = /** @class */ (function () {
    ...
    Utilities.checkNoNetwork = function (response) {
        if (response instanceof __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["g" /* HttpResponseBase */]) {
    ...
    Utilities.searchNotInArray = function (searchTerm, caseSensitive) {
        var values = [];
