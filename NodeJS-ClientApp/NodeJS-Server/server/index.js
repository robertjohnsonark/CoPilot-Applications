...
app.get('/api/get-roles', (req, res) => {
    users_1.default.getUsers(function (result) {
        if (result.status) {
            var resl = [];
...
app.get('/api/get-user', (req, res) => {
    ...
    users_1.default.getUser(req.get("emailId"), function (result) {
...
app.put('/api/get-users/:userId', (req, res) => {
    ...
    users_1.default.saveUser(req.params.userId, req.body, function (result) {
        if (res.status) {
