...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  get canViewProducts() {
    return this.accountService.userHasPermission(Permission.viewProductsPermission); //eg. viewProductsPermission
  }
  ...
  get canViewPermissions() {
    return this.accountService.userHasPermission(Permission.viewPermissionsPermission);
  }

  get canViewRolePermissions() {
    return this.accountService.userHasPermission(Permission.viewRolePermissionsPermission);
  }
}
