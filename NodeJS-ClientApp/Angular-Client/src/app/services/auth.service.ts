...
export class AuthService {
    ...
    constructor(private router: Router, private configurations: ConfigurationService, private endpointFactory: EndpointFactory, private localStorage: LocalStoreManager, private cookieService: CookieService) {
    ...
    private processLoginResponse(response: LoginResponse, rememberMe: boolean) {
        ...
        let permissions: PermissionValues[] = Array.isArray(response.user.permission) ? response.user.permission : [response.user.permission];

        let decodedIdToken: IdToken = response.user;
